...
from auth_api.internal.adapters.output.postgres.user.models import User as UserModel
from auth_api.internal.adapters.output.postgres.role.models import Role as RoleModel
from auth_api.internal.core.domain.models.user.user import User as DomainUser
from auth_api.internal.pkg.errors import EntityNotFoundError
from auth_api.internal.ports.output.user_repository import UserRepository, UserCreate
