...
from auth_api.internal.core.domain.models.role.role import Role as DomainRole, \
    ADMIN_ROLE_NAME
from auth_api.internal.pkg.errors import EntityNotFoundError, ForbiddenError
from auth_api.internal.ports.output.role_repository import RoleRepository, RoleCreate
